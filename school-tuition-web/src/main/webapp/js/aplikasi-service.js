angular.module('belajar.service', ['ngResource'])
    ...
    .factory('KelasService', ['$resource', '$http', function($resource, $http){
        var service = {
            kelases: $resource('table/kelas/:id', {}, {
                queryPage: {method:'GET', isArray: false}
            }),
            get: function(param, callback){ return this.kelases.get(param, callback) }, 
            query: function(p, callback){ return this.kelases.queryPage({"page.page": p, "page.size": 10}, callback) },
            save: function(obj){
                 if(obj.id == null){
