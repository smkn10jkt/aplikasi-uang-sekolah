...
.controller('KonfigurasiTagihanController', ['$scope', 'KonfigurasiTagihanService','KelasService', function($scope, KonfigurasiTagihanService, KelasService){
...
.controller('PembayaranDetailController', ['$scope', 'PembayaranDetailService','PembayaranService','TagihanDetailService', function($scope, PembayaranDetailService,PembayaranService,TagihanDetailService){
        $scope.pembayarandetails = PembayaranDetailService.query();
        $scope.pembayaran = PembayaranService.query();
        $scope.tagihan_detail = TagihanDetailService.query();
        $scope.edit = function(x){
            if(x.id == null){
...
.controller('KonfigurasiTagihanDetailController', ['$scope', 'KonfigurasiTagihanDetailService','JenisBiayaService','KonfigurasiTagihanService', function($scope, KonfigurasiTagihanDetailService, JenisBiayaService, KonfigurasiTagihanService){
        $scope.konfigurasitagihandetail = KonfigurasiTagihanDetailService.query();
         $scope.jenisbiaya = JenisBiayaService.query();
         $scope.konfigurasitagihan = JenisBiayaService.query();
        $scope.edit = function(x){
            if(x.id == null){
                return; 
            }
