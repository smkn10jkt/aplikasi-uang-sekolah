angular.module('belajar', ['ui', 'belajar.controller'])
    .config(['$routeProvider', function($routeProvider){
        $routeProvider
            ...
            .when('/master/konfigurasitagihan_detail', {templateUrl: 'pages/master/period.html', controller: 'Konfigurasitagihan_detailController'})
            ...
            .when('/table/pembayaran_detail', {templateUrl: 'pages/table/pembayaran_detail.html', controller: 'Pembayaran_detailController'})
